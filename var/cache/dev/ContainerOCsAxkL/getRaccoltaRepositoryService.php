...
// Returns the private 'App\Repository\RaccoltaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/RaccoltaRepository.php';

return $this->privates['App\Repository\RaccoltaRepository'] = new \App\Repository\RaccoltaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
