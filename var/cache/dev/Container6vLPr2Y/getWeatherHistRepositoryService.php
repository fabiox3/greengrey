...
// Returns the private 'App\Repository\WeatherHistRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/WeatherHistRepository.php';

return $this->privates['App\Repository\WeatherHistRepository'] = new \App\Repository\WeatherHistRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
