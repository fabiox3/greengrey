...
// Returns the private 'App\Repository\TreesRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TreesRepository.php';

return $this->privates['App\Repository\TreesRepository'] = new \App\Repository\TreesRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
