...
$a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\RaccoltaRepository' => function () {
    return ($this->privates['App\Repository\RaccoltaRepository'] ?? $this->load('getRaccoltaRepositoryService.php'));
...
}, 'App\\Repository\\TreesRepository' => function () {
    return ($this->privates['App\Repository\TreesRepository'] ?? $this->load('getTreesRepositoryService.php'));
...
}, 'App\\Repository\\WeatherHistRepository' => function () {
    return ($this->privates['App\Repository\WeatherHistRepository'] ?? $this->load('getWeatherHistRepositoryService.php'));
}))));
